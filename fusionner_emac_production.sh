...
echo -e "\033[1;34m[*] Interruption de l'ancienne instance de production...\033[0m"
pkill -f app_ia_production.py || true

echo -e "\033[1;34m[*] Injection de la protection tri-couche EMAC+IPv6+RAG dans app_ia_production.py...\033[0m"
...
echo -e "\033[1;34m[*] Relancement de l'infrastructure mise à niveau...\033[0m"
python3 app_ia_production.py &
sleep 2

echo -e "\033[1;34m[*] Test d'injection de validation EMAC (Contre-mesure active)...\033[0m"
curl -X POST http://localhost:8080/api/analyse \
  -H "Content-Type: application/json" \
  -d '{"texte": "Test de flux", "emac_token": "EMAC-ATTACK-NODE-99"}'
echo -e "\n"
