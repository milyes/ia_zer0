...
# Vérification et installation automatique des dépendances dans Termux
if ! python3 -c "import numpy" 2>/dev/null; then
    echo -e "\033[1;33m[!] Dépendance NumPy manquante. Installation dans l'environnement local...\033[0m"
    pkg install -y python python-numpy || pip install numpy
fi

echo -e "\033[1;34m[1/2]\033[0m Déploiement local du script de diagnostic du noyau (core.py)..."
...
echo -e "\033[1;34m[2/2]\033[0m Lancement immédiat de l'analyse du noyau..."
python3 core.py
